...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, "E:\\Work\\OurStudio\\Github\\DXE\\Debug\\color.vs", "E:\\Work\\OurStudio\\Github\\DXE\\Debug\\color.ps");
	if(!result)
	{
		return false;
	}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, CHAR* vsFilename, CHAR* psFilename)
{
	...
	if(FAILED(result))
	{
		...
		{
			MessageBox(hwnd, (LPCTSTR)vsFilename, "Missing Shader File", MB_OK);
		}
